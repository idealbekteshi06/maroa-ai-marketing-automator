  ...
  return (
    <section id="features" className="py-16 sm:py-20">
      <div className="container">
        ...
        <div className="mt-10 sm:mt-14 grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 px-2 sm:px-0">
          {features.map((f) => (
            <div key={f.title} className="group rounded-2xl border border-border bg-card p-6 transition-all duration-300 hover:shadow-meta-hover hover:-translate-y-0.5">
